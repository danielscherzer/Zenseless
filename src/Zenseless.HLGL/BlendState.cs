...
namespace Zenseless.HLGL
{
	...
	public struct BlendState : IEquatable<BlendState>
	{
		...
		/// </summary>
		/// <param name="blendOperator">The blend operator.</param>
		/// <param name="blendParameterSource">The blend parameter source.</param>
		/// <param name="blendParameterDestination">The blend parameter destination.</param>
